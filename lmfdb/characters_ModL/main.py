...
from lmfdb.characters_ModL import characters_ModL_page
from lmfdb.characters_ModL.characters_ModL_stats import get_stats
...
characters_ModL_credit = 'Samuele Anni, Peter Bruin, Nicolas Mascot'
...
def learn(current = None):
    ...
    if current != 'labels':
        r.append( ('Labels for Dirichlet characters mod &#x2113;', url_for(".labels_page")) )
    return r


@characters_ModL_page.route("/")
...
@characters_ModL_page.route("/Labels")
def labels_page():
    info = {}
...
@characters_ModL_page.route("/Source")
...
@characters_ModL_page.route("/Extent")
def extent_page():
    info = {}
...
@characters_ModL_page.route("/Dirichlet")
@characters_ModL_page.route("/Dirichlet/")
@characters_ModL_page.route("/Dirichlet/<modulus>")
@characters_ModL_page.route("/Dirichlet/<modulus>/")
@characters_ModL_page.route("/Dirichlet/<modulus>/<number>")
...
@characters_ModL_page.route('/Dirichlet/random')
...
@characters_ModL_page.route("/calc-<calc>/Dirichlet/<int:modulus>/<int:number>")
...
@characters_ModL_page.route("/Hecke/")
@characters_ModL_page.route("/Hecke/<number_field>")
@characters_ModL_page.route("/Hecke/<number_field>/<modulus>")
@characters_ModL_page.route("/Hecke/<number_field>/<modulus>/<number>")
...
@characters_ModL_page.route("/calc-<calc>/Hecke/<number_field>/<modulus>/<number>")
...
@characters_ModL_page.route("/Dirichlet/table")
def dirichlet_table():
    args = to_dict(request.args)
...
@characters_ModL_page.route("/Dirichlet/grouptable")
